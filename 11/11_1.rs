...
fn paint(program: &mut Program, grid: &mut Vec<i64>, grid_size: usize, painted_panels: &mut HashSet<(usize, usize)>) {
...
fn main() {
    ...
    paint(&mut program, &mut grid, GRID_SIZE, &mut painted_panels); 
